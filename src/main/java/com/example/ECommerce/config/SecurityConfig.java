...
//                .password(encoder.encode("harsh"))  // <-- Encode the password
//                .roles("ADMIN", "USER")
//                .build();
//
//        UserDetails user1 = User.withUsername("nandakishore")
//                .password(encoder.encode("nandakishore"))  // <-- Encode the password
//                .roles("ADMIN", "USER")
//                .build();
//        UserDetails user2 = User.withUsername("harshit")
//                .password(encoder.encode("harshit"))  // <-- Encode the password
//                .roles("ADMIN", "USER")
//                .build();
//
